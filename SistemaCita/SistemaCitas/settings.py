"""
Django settings for Clinica2025 project.
Adaptado para despliegue en Render.com con PostgreSQL y Whitenoise.
"""
...
SECRET_KEY = os.getenv('SECRET_KEY', 'clave_insegura_local')

# Render establece una variable de entorno llamada 'RENDER'
...
ROOT_URLCONF = 'SistemaCitas.urls'  # 👈 si tu carpeta del proyecto aún se llama SistemaCitas, déjalo así
